...
const nightModeButton = document.querySelector("li button");

nightModeButton.addEventListener("click", () => {

    const root = document.documentElement;

    if (nightModeButton.classList.contains("night")) {
        nightModeButton.classList.remove("night");
        nightModeButton.classList.add("day");
        nightModeButton.innerHTML = '<i class="fa-solid fa-sun fa-2xl"></i>';

        root.style.setProperty("--main-theme", "#FDEDEC");
        root.style.setProperty("--font-color", "#black");
    }

    else {
        nightModeButton.classList.remove("day");
        nightModeButton.classList.add("night");
        nightModeButton.innerHTML = '<i class="fa-solid fa-moon fa-2xl"></i>';

        root.style.setProperty("--main-theme", "#0d0a20");
